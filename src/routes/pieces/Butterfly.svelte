...
>
  ...
  <p>
    ...
    airport. It’s about not being seen. It’s about making up excuses, making up
    stories. It’s about being consistent in my stories. It’s about telling
  ...
  <p>
    ...
    I always do. I’m hoping someone is recording the event but I’ll find out
    later that no one is. I won’t be the only one regretting that the event
  ...
  <p>
    Crossing the border doesn’t make it any easier. Crossing the border is when
    ...
    escape. Even before the airport and the border it’s the messages and the
    codes. It’s the letter drops and the fake names. It’s covering tracks. Field
    craft teaches you that it’s easier to cover tracks before you’ve even made
    them. It’s easier now and it’s harder. Different contacts, different names,
    different addresses. Knowing who she is when she contacts you even if the
    name isn’t your name for her. Knowing how to respond. Knowing which
  ...
  <p>
    ...
    a dash for the door before I’m spotted. It means I’m on edge the entire
    time. Ignore what’s outside the windows. Don’t be a tourist, don’t be a
    ...
    window because we’ve all seen it a million times before. Don’t meet anyone’s
  ...
  <p>
    A place has no meaning without a border. A place is a space given a name by
  ...
  <p>
    ...
    but it’s as much to avoid looking up as anything else. I have no signal but
    I know I’ll have a chance when I change trains. The platforms are crowded
  ...
  <p>
    Places have no meaning until they are given a meaning by giving them a name.
  ...
  <p>
    I message her to say I’m on my way. Nothing more. Nothing less. If they know
    I’m here we’re caught anyway. If not it’s just the same message as hundreds,
    if not thousands, are sending this moment across the city. Changing trains
    means a safer train. I’m less likely to be spotted now. Moving through a
  ...
  <p>
    ...
    she’s Jane but she doesn’t go by that name with anybody else. Every time she
    hears one of her names on a street or across a room she has to know where
    she is and who she is this time. She can’t afford to have her cover blown by
    answering a name she hasn’t been called. One doubt. One question and she’s
    dead.
  </p>
  <p>
    ...
    least there would be an accurate record of the artist speaking that isn’t
    filtered through a different idea in my head.
  </p>
  <p>
    There’s no reply from her. I don’t expect one. We’re underground now anyway.
    She knows when I’m due to arrive. At the final station I wheel my bag up the
    ...
    by. One walks in the direction I’m going while the others turn right and
    wait at the pedestrian crossing. It’s about watching. Waiting I can see if
    I’m being followed. Waiting I can see if they’re on to me. Nothing. Nothing
  ...
  <p>
    ...
    shouldn’t have been listening to innocent questions. Keeping her cover while
    answering innocent questions.
  </p>
  <p>
    Borders exist because of force. Borders exist because of agreement. Borders
  ...
  <p>
    ...
    message her again to say I’m at the station. I’m waiting for the all clear.
    I’m waiting for her to say it’s safe to come up. I keep my head down on the
    street. It’s too close and too late to have my cover blown now. If they get
    ...
    a few times until she says it’s safe, until she’s ready for me to call. I
    guess the layout of the streets and walk laps of her building, of her
    street. I glance behind me when I can to check. Few people pass me. It’s a
  ...
  <p>
    ...
    beginner’s mistake. Watch. That’s the whole thing, watch without being seen
    to watch. I turn a corner and pass a school. Make a note. Don’t pass this
    way again. You can pass an office building, a row of shops or apartments or
    houses, or anywhere else more than once. But you can’t pass a school for a
  ...
  <p>
    Borders exist within borders. A spy can live within a border and only become
  ...
  <p>
    I want to message her again, I want to pass her building and pass her door,
    ...
    check my phone. It’s late. She’s late. I try to avoid walking up and down
    the same streets but I’m conscious of not walking too far from her place in
    ...
    wheeling a bag sitting on a bench looking at the river won’t attract any
  ...
  <p>
    ...
    to look over her shoulder without making it look like she’s looking over her
  ...
  <p>
    ...
    it isn’t touching a page? Is a page a page if there is nothing making
  ...
  <p>
    ...
    it’s not safe. I picture all the things that can go wrong but my phone
    buzzes and she says to come up. At this point I just turn back on myself. I
    don’t care. I have my phone in my hand so if I’m stopped, if I’m questioned
    I can just say there’s been a change of plans and I have to go in this
  ...
  <p>
    If I’m spotted from a building, if I’m watched from a building it’s too late
    anyway. If I’m recorded turning into the side street by the side of her
    building it’s too late anyway. If someone is going to see me, if someone is
    going to say or do anything it will be now. I approach her door. I look up
    at her window. Even when I’m close enough I see nothing in her window,
    nothing that isn’t in every other window. There’s a desk inside the door of
    her building but it’s unmanned. Nobody there. Nobody in the hallway. Nobody
  ...
  <p>
    ...
    behind. Learning what is and isn’t important. Learning that it may be
  ...
  <p>
    ...
    them. She knows who she has told and who she hasn’t. She knows how to pick
  ...
  <p>
    ...
    moving somewhere else. I don’t know if she means to mention this event as
  ...
  <p>
    Checking herself when she crosses a border she files away anything she won’t
    need, any stories she won’t need. Every spy operates in a cell of their own.
  ...
  <p>
    ...
    makes a meal. I watch and offer to help. We sit on the couch in each other’s
    ...
    is our border we’ve closed. We touch as we pass cleaning up glasses and
  ...
  <p>
    The door is just a door now. The chain is just a chain. The corridor outside
